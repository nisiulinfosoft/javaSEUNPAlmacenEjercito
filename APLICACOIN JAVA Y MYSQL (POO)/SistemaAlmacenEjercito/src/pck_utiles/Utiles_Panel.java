...
import pck_utiles.JInternalFrame_Modelo;
...
public class Utiles_Panel {
    ...
    //(vale)
    public static pck_utiles.JInternalFrame_Modelo creaVentanaInterna_Panel( org.jdesktop.application.FrameView padre, javax.swing.JPanel panel, String t ){
        JInternalFrame_Modelo vi = new pck_utiles.JInternalFrame_Modelo(panel, t, false, true, false, true );
    ...
    public static pck_utiles.JInternalFrame_Modelo creaVentanaInternaModal( org.jdesktop.application.FrameView vpadre, javax.swing.JPanel panel, String t ){
        //Creo la Ventana Iterna
        JInternalFrame_Modelo vimodal = new pck_utiles.JInternalFrame_Modelo(panel, t, false, true, false, false );
        vimodal.setContentPane( panel );
        //Agrego la ventana interna al contenedor principal de la ventana padre
