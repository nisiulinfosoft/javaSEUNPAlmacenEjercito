...
public class Jpn_Gestion_Prestamo_BuscarCliente extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Gestion_Prestamo_BuscarCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Gestion_Prestamo_BuscarCliente.class);
    ...
    private void tablaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClienteMouseClicked
        ...
        //Cerrar ventatna
        if(this.getRefDep() instanceof Jpn_Gestion_Prestamo)//para ver quien fue quien lo llamo
        {
            ((Jpn_Gestion_Prestamo)this.getRefDep()).obtenerCliente(ccodigo);
        }
        this.cerrarPadre();
