...
public class Jpn_Gestion_Prestamo_BuscarUsuario extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Gestion_Prestamo_BuscarUsuario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Gestion_Prestamo_BuscarUsuario.class);
    ...
    private void tablaUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUsuarioMouseClicked
        ...
        {
            ((Jpn_Gestion_Prestamo)this.getRefDep()).obtenerUsuario(ccodigo);
        }
        this.cerrarPadre();
