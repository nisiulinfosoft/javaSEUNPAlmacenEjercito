...
public class Jpn_Cliente_Consulta extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Cliente_Consulta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Cliente_Consulta.class);
        ...
        tablaCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Apellido Paterno", "Apelliodo Materno"
            }
        ) {
