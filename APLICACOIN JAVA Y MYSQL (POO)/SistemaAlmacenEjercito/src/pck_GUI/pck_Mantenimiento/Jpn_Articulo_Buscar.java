...
public class Jpn_Articulo_Buscar extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Articulo_Buscar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Articulo_Buscar.class);
    ...
    private void tablaArticuloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaArticuloMouseClicked
        ...
        //Cerrar ventatna
        if(this.getRefDep() instanceof Jpn_Articulo_Mantenimiento)//para ver quien fue quien lo llamo
        {
            ((Jpn_Articulo_Mantenimiento)this.getRefDep()).obtenerArticulo(ccodigo);
            ((Jpn_Articulo_Mantenimiento)this.getRefDep()).habilitarBotones(false, false, true, true, true,true);
        }
        this.cerrarPadre();
