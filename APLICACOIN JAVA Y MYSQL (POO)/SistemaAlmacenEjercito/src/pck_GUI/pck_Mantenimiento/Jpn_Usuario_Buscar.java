...
public class Jpn_Usuario_Buscar extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Usuario_Buscar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Usuario_Buscar.class);
    ...
    private void tablaUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUsuarioMouseClicked
        ...
        //Cerrar ventatna
        if(this.getRefDep() instanceof Jpn_Usuario_Mantenimiento)//para ver quien fue quien lo llamo
        {
            ((Jpn_Usuario_Mantenimiento)this.getRefDep()).obtenerUsuario(ccodigo);
            ((Jpn_Usuario_Mantenimiento)this.getRefDep()).habilitarBotones(false, false, true, true, true,true);
        }
        this.cerrarPadre();
