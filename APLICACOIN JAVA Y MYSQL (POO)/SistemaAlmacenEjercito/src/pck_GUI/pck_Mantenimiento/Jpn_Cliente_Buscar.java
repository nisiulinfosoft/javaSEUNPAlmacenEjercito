...
public class Jpn_Cliente_Buscar extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Cliente_Buscar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Cliente_Buscar.class);
    ...
    private void tablaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClienteMouseClicked
        ...
        //Cerrar ventatna
        if(this.getRefDep() instanceof Jpn_Cliente_Mantenimiento)//para ver quien fue quien lo llamo
        {
            ((Jpn_Cliente_Mantenimiento)this.getRefDep()).obtenerCliente(ccodigo);
            ((Jpn_Cliente_Mantenimiento)this.getRefDep()).habilitarBotones(false, false, true, true, true,true,false);
        }
        this.cerrarPadre();
