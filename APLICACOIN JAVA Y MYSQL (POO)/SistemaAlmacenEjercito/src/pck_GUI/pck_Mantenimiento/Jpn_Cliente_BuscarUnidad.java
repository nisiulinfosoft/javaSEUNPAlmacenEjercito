...
public class Jpn_Cliente_BuscarUnidad extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Cliente_BuscarUnidad() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Cliente_BuscarUnidad.class);
    ...
    private void tablaUnidadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUnidadMouseClicked
        ...
        {
            ((Jpn_Cliente_Mantenimiento)this.getRefDep()).obtenerUnidad(ccodigo);
        }
        this.cerrarPadre();
