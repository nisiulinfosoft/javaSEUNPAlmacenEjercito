...
public class Jpn_Unidad_Buscar extends JP_Modelo {

    String codigo="";
    String nombre="";

    public Jpn_Unidad_Buscar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemaalmacenejercito.SistemaAlmacenEjercitoApp.class).getContext().getResourceMap(Jpn_Unidad_Buscar.class);
    ...
    private void tablaUnidadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUnidadMouseClicked
        ...
        //Cerrar ventatna
        if(this.getRefDep() instanceof Jpn_Unidad_Mantenimiento)//para ver quien fue quien lo llamo
        {
            ((Jpn_Unidad_Mantenimiento)this.getRefDep()).obtenerUnidad(ccodigo);
            ((Jpn_Unidad_Mantenimiento)this.getRefDep()).habilitarBotones(false, false, true, true, true,true);
        }
        this.cerrarPadre();
